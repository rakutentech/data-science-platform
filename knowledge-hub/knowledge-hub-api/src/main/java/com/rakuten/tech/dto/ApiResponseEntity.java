...
public class ApiResponseEntity {
  ...
  public ApiResponseEntity(int status, String error, String message,
  ...
  public ApiResponseEntity(int status, String error, String message, String exception, String path,
      String method) {
    this.status = status;
    this.error = error;
